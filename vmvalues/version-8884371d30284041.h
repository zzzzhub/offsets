...
// dumped 14/14 fields in 26.58s

inline constexpr std::uintptr_t PROTO_DEBUGNAME = 0x20;
inline constexpr std::uintptr_t PROTO_DEBUGINSN = 0x28;
inline constexpr std::uintptr_t PROTO_UPVALUES = 0x8;
inline constexpr std::uintptr_t PROTO_ABSLINEINFO = 0x60;
inline constexpr std::uintptr_t PROTO_USERDATA = 0x18;
inline constexpr std::uintptr_t PROTO_LINEINFO = 0x50;
inline constexpr std::uintptr_t PROTO_LOCVARS = 0x80;
inline constexpr std::uintptr_t PROTO_TYPEINFO = 0x30;
inline constexpr std::uintptr_t PROTO_SOURCE = 0x10;
...
inline constexpr std::uintptr_t LSTATE_STACKSIZE = 0x60;
